...
var venues = db.venues.insertMany([
  { name: "Opera", capacity: 500 },
  { name: "Bibliotheca", capacity: 300 },
  { name: "Cairo Stadium", capacity: 800 },
  { name: "Egyptian Theater", capacity: 400 }
]);

// 6 Events
var events = db.events.insertMany([
  { name: "Concert", date: new Date("2026-01-01"), price: 200, venueId: venues.insertedIds[0] },
  { name: "Tech Talk", date: new Date("2026-03-10"), price: 100, venueId: venues.insertedIds[1] },
  { name: "Football Match", date: new Date("2026-02-01"), price: 300, venueId: venues.insertedIds[2] },
  { name: "Theater Play", date: new Date("2026-02-05"), price: 150, venueId: venues.insertedIds[3] },
  { name: "Art Exhibition", date: new Date("2026-05-01"), price: 80, venueId: venues.insertedIds[1] },
  { name: "Startup Meetup", date: new Date("2026-05-15"), price: 50, venueId: venues.insertedIds[0] }
]);
